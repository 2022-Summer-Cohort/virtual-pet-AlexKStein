...
public class VirtualPetTest {
    ...
    public void robotDogShouldBeLessBoredAndMoreThirsty(){
        RobotDog underTest = new RobotDog("Frodo", "Robot dog", "~Bark~", 30, 30, 30, false, 25);
        underTest.walk();
    ...
    public void organicDogShouldHaveBathroomResetAndLessBored(){
        OrganicDog underTest = new OrganicDog("Korra", "Organic dog", "Arooo", 50, 50, 50, false, 50, true, 75);
        underTest.walk();
    ...
    public void robotCatShouldHaveThirstResetAndGainEnergy(){
        RobotCat underTest = new RobotCat("Bender", "robot cat", "meowZzZ", 0, 50, 75, false, 25);
        underTest.hydrate();
    ...
    public void robotShouldFullyChargeAndOrganicEnergyShouldStayTheSame(){
        OrganicCat samwise = new OrganicCat("Samewise", "organic cat", "meow", 0, 50, 0, false, 0, true, 0, 0);
        RobotCat gandalf = new RobotCat("Gandalf", "robot cat", "MeowZzza", 0, 50, 0, false, 0);
